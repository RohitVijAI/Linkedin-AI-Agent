...
# installed.
TCL_PREFIX='C:/AI_LINKDIN_AGENT/venu\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/AI_LINKDIN_AGENT/venu\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/AI_LINKDIN_AGENT/venu\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/AI_LINKDIN_AGENT/venu\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/AI_LINKDIN_AGENT/venu\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/AI_LINKDIN_AGENT/venu\Library\lib\tclstub86.lib'
